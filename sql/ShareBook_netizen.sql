...
--
-- Table structure for table `netizen`
--

DROP TABLE IF EXISTS `netizen`;
...
--
-- Dumping data for table `netizen`
--

LOCK TABLES `netizen` WRITE;
/*!40000 ALTER TABLE `netizen` DISABLE KEYS */;
/*!40000 ALTER TABLE `netizen` ENABLE KEYS */;
UNLOCK TABLES;
