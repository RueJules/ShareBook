...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`id`),
  KEY `send_idx` (`sender`),
  KEY `receive_idx` (`recipient`),
  CONSTRAINT `receive` FOREIGN KEY (`recipient`) REFERENCES `netizen` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `send` FOREIGN KEY (`sender`) REFERENCES `netizen` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
