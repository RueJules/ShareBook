...
Note::Note(int id, std::string title, std::string text, int materialCount, std::string imgsrc,QDateTime time, int blogger):NoteInterface{id},m_title{title},m_text{text},m_firstImgsrc{imgsrc},m_time{time},m_bloggerId{blogger}
{
